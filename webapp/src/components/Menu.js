...
class Menu extends React.Component {
  constructor(props){
    ...
    render() {
        ...
        <div className="container"><a className="navbar-brand d-xl-flex justify-content-xl-center" href="/" style={{ marginRight: '0px', padding: '0px', height: '100px', width: '100px' }}><br />
