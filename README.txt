hoàn chỉnh boostrap(những việc đã sửa):
- Thứ 1 sửa ảnh logo: chỉnh sửa lại thành 1 Navbar chứa logo ảnh và đường link khi nhấn sẽ trở về trang đầu
- Thứ 2 là thêm nav item HOME trỏ về trang đầu và nav item TECHNICAL để thành viên khác thêm dữ liệu firebase
- Thứ 3: chỉnh lại toàn bộ id của các nav item theo đúng tên(cùng tên với tên nav item) và thứ tự khi trỏ đến các section
- Thứ 4: thay đổi lời chào thành "HAVE A GREAT DAY"
